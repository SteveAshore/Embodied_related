...
from rsl_rl.utils import quaternion_slerp, quaternion_inverse, quaternion_multiply
...
def QuaternionRotatePoint(point, quat):
    ...
    quat_inverse = quaternion_inverse(quat)
    q_point_rotated = quaternion_multiply(
        quaternion_multiply(quat, q_point), quat_inverse)
